    ...
    <Card>
      <div className="flex flex-wrap items-center gap-2 border-b border-hair p-3 sm:gap-3 sm:p-4">
        ...
        <button
          ...
          className="ml-auto shrink-0 cursor-pointer rounded-xl border border-hair bg-surface px-3 py-2 text-[13px] font-semibold text-ink-sec transition hover:border-axis hover:text-ink"
        >
